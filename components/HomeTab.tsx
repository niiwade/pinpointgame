...
import SparklingCoins from '@/icons/SparklingCoins'
    ...
    return (
        <div className={`home-tab-con transition-all duration-300`}>
            ...
            <div className="flex flex-col items-center mt-8">
                <SparklingCoins className="w-2 h-2 mb-4" />
                <div className="flex items-center gap-1 text-center">
                    <div className="text-6xl font-bold mb-1">4032</div>
                    <div className="text-white text-2xl ml-3">PinPoints</div>
                </div>
